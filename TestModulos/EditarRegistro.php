...
while($row = mysql_fetch_assoc($results)){
	...
	<form action='func.edit.php' method='post'>
		...
		<input type='text' name='title' value='$row[Nombre]'/>
		<input type='text' name='link' value='$row[Tipo]'/>
		<input type='text' name='author' value='$row[Descripcion]'/>
		<textarea name='description'>$row[Precio]</textarea>
